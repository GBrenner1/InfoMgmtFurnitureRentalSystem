...
public class MemberRegistrationController
{
    ...
    public static bool AddMember(string fName, string lName, string gender, string phone, string address, string city,
        string state, string zip, DateTime birthdate)
    {
